...
![Inverse Atlas Main Hero](./figures/inverse_atlas_main_hero.png)
...
![Inverse Atlas Hero Order Shift](./figures/inverse_atlas_hero_order_shift.png)
...
![Inverse Atlas Design Contrast](./figures/inverse_atlas_design_contrast.png)
...
![Inverse Atlas Governance Map](./figures/inverse_atlas_governance_map.png)
...
![Inverse Atlas Family Positioning](./figures/inverse_atlas_family_positioning.png)

### 🧬 Atlas Family Positioning

- [Troubleshooting Atlas](../wfgy-ai-problem-map-troubleshooting-atlas.md)  
...
<details>
<summary><strong>What does the demo actually show?</strong></summary>
